## MatriCom usage for kidney case study
All steps discussed below are included in a **single script**, called [kidney.R](kidney.R).

To demonstrate the applications of MatriCom analysis output, we performed a case study with the Kidney ([Stewart et al., Science 2019](https://www.science.org/doi/10.1126/science.aat5031)) dataset using original sample annotations. The communication network table was generated by running MatriCom with all default query parameters and exported with all default filters active. 
